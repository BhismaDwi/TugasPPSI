...
if(isset($_GET['search'])){
    if(isset($_GET['search']))
    {
        ...
        $query = "SELECT * FROM `db_security` WHERE nama_security LIKE '%".$valueToSearch."%' order by id_security asc ";
        $search_result = filterTable($query);
        
    }else {
        $query = "SELECT * FROM `db_security` order by id_security asc";
        $search_result = filterTable($query);
    }
}else{
    $query = "SELECT * FROM `db_security` order by id_security asc";
...
{
    $connect = mysqli_connect("localhost", "root", "", "u157331241_dbvis");
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Nama Security</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Data Akun Pegawai</h4>
                                <!-- <p class="category">Here is a subtitle for this table</p> -->
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            ?>
                                        <tr>
                                        	<td><?php echo $row['id_security'] ?></td>
                                            ...
                                            <td><?php 
                                                ...
                                                ?></td>
                                            <td><a href="ubah_status_security.php?id=<?php echo $row['id_security'] ?>" class="btn btn-warning"><span aria-hidden="true">Beri Akses</a>
                                            <a href="ubah_status_hapus_security.php?id=<?php echo $row['id_security'] ?>" class="btn btn-danger"><span aria-hidden="true">Hapus Akses</span></a></td>
                                        </tr>
                                        <?php
                                                endwhile;
                                            ?>
...
<script>
    ...
    function notsweet(){
        swal("Erase!", "You already Erase The Access!", "success");
    }
</script>
</body>
